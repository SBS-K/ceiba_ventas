...
public class ServicioCrearCategoria {
    ...
    public static final String LA_CATEGORIA_YA_EXISTE_EN_EL_SISTEMA = "La categoria ya existe en el sistema";
    ...
    private void validarExistenciaPrevia(Categoria categoria) {
        ...
        if(existe) {
            throw new ExcepcionDuplicidad(ServicioCrearCategoria.LA_CATEGORIA_YA_EXISTE_EN_EL_SISTEMA);
        }
    }
}
