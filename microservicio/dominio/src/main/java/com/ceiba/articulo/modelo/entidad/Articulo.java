...
public class Articulo {
    ...
    private static final String EL_PRECIO_DEL_ARTICULO_DEBE_SER_MAYOR_A_ZERO = "El precio del articulo debe ser mayor a zero";
    ...
    public Articulo(Long id, String nombre, String descripcion, Double precio, Categoria categoria) {
        ...
        validarPositivo(precio, EL_PRECIO_DEL_ARTICULO_DEBE_SER_MAYOR_A_ZERO);
